  ...
  const webProjects = [
    {
      ...
      image: Mallzonix,
      tags: ["React.js", "Firebase", "Firestsore", "Paystack", "TailwindCSS","Vercel","Tawk.to Chatbot/AI"],
  ...
  const mobileProjects = [
    {
      id: 3,
      title: "Hostelhubb",
      description: "HostelHubb is a mobile application designed to help students find and book accommodation in hostels easily and efficiently, offering a seamless platform for exploring available options and securing a place to stay.",
      image: Hostelhubb,
    ...
    },
    {
      ...
      description: "The KNUST Attendance App is a mobile solution that allows guardians, scholarship sponsors, and the university to track and monitor students' attendance in real-time. This app ensures transparency and accountability, providing stakeholders with direct insights into student participation, and helping the school maintain accurate attendance records for better academic support.",
    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-900">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <Link
            to="/projects"
            className="inline-flex items-center gap-2 px-6 py-3 bg-green-500 hover:bg-green-600 text-black font-medium rounded-md transition-colors duration-300"
          >
