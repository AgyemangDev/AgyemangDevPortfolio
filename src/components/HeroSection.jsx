        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.div
              ...
              // 👇 Responsive layout: side by side even on mobile
              className="flex flex-row flex-wrap gap-3 sm:gap-4"
            >
              <button
                onClick={handleDownloadCV}
                className="flex-1 min-w-[140px] sm:flex-none px-6 py-3 bg-green-500 hover:bg-green-600 text-black font-medium rounded-md flex items-center justify-center gap-2 transition-colors duration-300"
              >
              ...
              <Link
                to="/projects"
                className="flex-1 min-w-[140px] sm:flex-none px-6 py-3 border border-green-500 text-green-500 hover:bg-green-500/10 font-medium rounded-md flex items-center justify-center gap-2 transition-colors duration-300"
              >
